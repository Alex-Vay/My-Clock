...
const val STOPWATCH_TOGGLE_ACTION = "com.nr.myclock.TOGGLE_STOPWATCH"
...
fun getAllTimeZones() = arrayListOf(
    CurrentTimeZone(1, "GMT-08:00 Los Angeles", "America/Los_Angeles"),
    CurrentTimeZone(2, "GMT-07:00 Denver", "America/Denver"),
    CurrentTimeZone(3, "GMT-06:00 Costa Rica", "America/Costa_Rica"),
    CurrentTimeZone(4, "GMT-06:00 Chicago", "America/Chicago"),
    CurrentTimeZone(5, "GMT-06:00 Mexico City", "America/Mexico_City"),
    CurrentTimeZone(6, "GMT-05:00 New York", "America/New_York"),
    CurrentTimeZone(7, "GMT+00:00 Greenwich Mean Time", "Etc/Greenwich"),
    CurrentTimeZone(8, "GMT+01:00 Amsterdam", "Europe/Amsterdam"),
    CurrentTimeZone(9, "GMT+01:00 Belgrade", "Europe/Belgrade"),
    CurrentTimeZone(10, "GMT+01:00 Brussels", "Europe/Brussels"),
    CurrentTimeZone(11, "GMT+01:00 Madrid", "Europe/Madrid"),
    CurrentTimeZone(12, "GMT+02:00 Helsinki", "Europe/Helsinki"),
    CurrentTimeZone(13, "GMT+02:00 Jerusalem", "Asia/Jerusalem"),
    CurrentTimeZone(14, "GMT+03:00 Minsk", "Europe/Minsk"),
    CurrentTimeZone(15, "GMT+03:00 Baghdad", "Asia/Baghdad"),
    CurrentTimeZone(16, "GMT+03:00 Moscow", "Europe/Moscow"),
    CurrentTimeZone(17, "GMT+03:30 Tehran", "Asia/Tehran"),
    CurrentTimeZone(18, "GMT+04:00 Baku", "Asia/Baku"),
    CurrentTimeZone(19, "GMT+04:00 Tbilisi", "Asia/Tbilisi"),
    CurrentTimeZone(20, "GMT+04:00 Yerevan", "Asia/Yerevan"),
    CurrentTimeZone(21, "GMT+04:00 Dubai", "Asia/Dubai"),
    CurrentTimeZone(22, "GMT+05:00 Yekaterinburg", "Asia/Yekaterinburg"),
    CurrentTimeZone(23, "GMT+05:30 Colombo", "Asia/Colombo"),
    CurrentTimeZone(24, "GMT+05:45 Kathmandu", "Asia/Kathmandu"),
    CurrentTimeZone(25, "GMT+08:00 Hong Kong", "Asia/Hong_Kong"),
    CurrentTimeZone(26, "GMT+08:00 Irkutsk", "Asia/Irkutsk"),
    CurrentTimeZone(27, "GMT+10:00 Vladivostok", "Asia/Vladivostok"),
    CurrentTimeZone(28, "GMT+10:00 Guam", "Pacific/Guam"),
    CurrentTimeZone(29, "GMT+10:00 Magadan", "Asia/Magadan"),
