...
import com.nr.myclock.clock.activities.models.ObfuscatedAlarm
import com.nr.myclock.clock.activities.models.ObfuscatedTimer
...
class Configuration(context: Context) : BaseConfig(context) {
    companion object {
        fun newInstance(context: Context) = Configuration(context)
    }
