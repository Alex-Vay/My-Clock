...
import com.nr.myclock.databinding.ActivityReminderBinding
...
class ClockReminderActivity : SimpleActivity() {
    companion object {
        ...
        if (soundUri != SILENT) {
            try {
                mediaPlayer = MediaPlayer().apply {
                    ...
                    setDataSource(this@ClockReminderActivity, Uri.parse(soundUri))
                    isLooping = true
                    prepare()
                    start()
                }
